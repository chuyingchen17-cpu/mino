...
@Observable
@MainActor
private final class VisitInvitationBannerModel {
    var current: VisitInvitationPresentation?
    var remainingCount = 0
    var operationInProgress = false
    var pendingResponse: VisitResponse?
...
private struct VisitInvitationBannerView: View {
    @Bindable var model: VisitInvitationBannerModel
